# frontend-assignment-core-php

## Tech Stack
- Core PHP
- HTML, CSS, bootstrap, JavaScript and JSON

  ## Project Overview
This assignment is implemented in **two versions**:

1. **Core PHP Version** – Uploaded to this GitHub repository  
2. **CodeIgniter 3 Version** – Deployed live (demo link provided below)
3. https://showpage.rf.gd/basizforntenddevassignment/
